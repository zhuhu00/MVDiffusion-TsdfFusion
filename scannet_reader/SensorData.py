...
class SensorData:
  ...
  def load(self, filename):
    with open(filename, 'rb') as f:
      ...
      self.color_compression_type = COMPRESSION_TYPE_COLOR[int(struct.unpack('i', f.read(4))[0])]
      self.depth_compression_type = COMPRESSION_TYPE_DEPTH[int(struct.unpack('i', f.read(4))[0])]
